          ...
          <div className="h-full overflow-y-auto">
            <DrawerHeader className="px-4 py-3 border-b sticky top-0 bg-white z-10">
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="icon" className="rounded-full h-8 w-8" onClick={handleContinueShopping}>
                  <X className="h-4 w-4" />
                </Button>
              </div>
            </DrawerHeader>
            ...
            {cart.length > 0 && (
              <DrawerFooter className="px-4 py-4 border-t">
                <Button className="w-full h-12 bg-black hover:bg-black/90" onClick={handleContinueToPayment}>
                  Continue to Payment
                </Button>
