  ...
  useEffect(() => {
    if (!editingCartItem && selectedItem) {
      ...
      const availableModifiers =
        categoryModifierMapping[selectedItem.category as keyof typeof categoryModifierMapping] || []
    ...
    <Drawer open={isOpen} onOpenChange={onOpenChange}>
      <DrawerContent className="max-h-[95vh] p-0 max-w-md mx-auto rounded-t-[20px]">
            ...
            <div className="px-4 py-6 space-y-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-bold mt-2">{formatPrice(selectedItem.price)}</p>
                </div>
              </div>
                          ...
                          return (
                            <div key={modifierCategory}>
                              <h3 className="font-semibold mb-3">
                                {modifierCategory}{" "}
                                <span className="text-sm font-normal text-muted-foreground">(Max 3)</span>
                              </h3>
                                ...
                                {modifiers[modifierCategory].map((modifier) => (
                                  ...
                                  >
                                    ...
                                    <div className="flex-1 flex justify-between items-center">
                                      ...
                                      {modifier.price > 0 && (
                                        <span className="text-muted-foreground">+{formatPrice(modifier.price)}</span>
                                      )}
                                    </div>
                                  </Label>
                                ))}
        ...
        <DrawerFooter className="px-4 py-4 border-t">
          <Button onClick={handleSubmit} className="w-full h-12 bg-black hover:bg-black/90" disabled={!selectedItem}>
